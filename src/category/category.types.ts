...
export interface CategoryControllerContract {
    getAll: (
        req: Request<object, CategoryGetAllResponse, object, CategoryGetAllQuery>,
    ...
    fullUpdate: (
        req: Request<{ id: string }, CategoryFullUpdateResponse, CategoryFullUpdateBody>,
...
export interface CategoryServiceContract {
    getAll: (query: CategoryGetAllQueryParsed) => Promise<CategoryGetAllResponse>;
    getById: (id: number) => Promise<CategoryGetByIdResponse>;
    create: (query: CategoryCreateBody) => Promise<CategoryCreateResponse>;
    fullUpdate: (query: CategoryFullUpdateBody, id: number) => Promise<CategoryFullUpdateResponse>;
